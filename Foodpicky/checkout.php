                    ...
                    <div class="container">
                        <ul class="row links">
                            ...
                            <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose
                                    Restaurant</a></li>
                            <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Pick your favourite
                                    dishes</a></li>
                                                    ...
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-10">
                                                            <input name="mod" type="radio" value="esewa"
                                                                ...
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description"><img
                                                                    src="images/esewa.jpeg" alt="" width="90"></span>
                                                            <br><br> <span>Pay digitally with your digital wallet.</span>
                                                        </label>
                                                    </li>
                                                </ul>
