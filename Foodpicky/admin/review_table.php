...
<body class="fix-header fix-sidebar">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All User Reviews</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT users.*, reviews.*, restaurant.*, restaurant.title
                                           FROM users
                                           INNER JOIN reviews ON users.u_id = reviews.user_id
                                           INNER JOIN restaurant ON reviews.restaurant_id = restaurant.rs_id";
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    <td>
                                                        <a href="delete_review.php?review_del=<?php echo $rows['review_id']; ?>"
                                                            onclick="return confirm('Are you sure?');"
                                                            class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i
                                                                class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                        <?php
                                                        echo '<a href="view_review.php?user_upd=' . $rows['o_id'] . '" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
    ...
    <!-- footer -->
    <footer class="footer"> © 2023 All rights reserved. Made with &#x1F49C; by <b>
            Sneha & Pooja </footer>
    <!-- End footer -->
    </div>
    <!-- End Page wrapper  -->
